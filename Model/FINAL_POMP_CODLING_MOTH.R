...
library(pomp2)#ENSURE THAT YOU ARE USING POMP2 NOT POMP
#library(here)
...
DIA_SKEL <- Csnippet("/////////////////////////////////////////////////////////////////////////////////
                    ...
                    //////////////
                     ...
                     B =  birth_a * exp(-0.50* powl ((TT- birth_t), 2.0) / powl (birth_b, 2.0));
...
PARAMETERS<-   c(birth_a =10.52  , #Egg Fecundity 
                 birth_t=24.629, #...
                 birth_b = 3.427, #...
  
                 alphaE_a=0.1927, #Egg Development rate
                 alphaE_b=0.3039, #...
                 alphaE_c= 18.5929, #...
